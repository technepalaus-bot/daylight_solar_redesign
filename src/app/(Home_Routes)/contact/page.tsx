  ...
  return (
    <div className="animate-fadeIn">
      ...
      <section className="bg-primary text-white pt-20 pb-24 px-4 sm:px-[87px] text-center">
        ...
        <p className="text-tertiary mb-10 max-w-xl mx-auto">Reach out to us through any of these channels</p>
        ...
        <div className="max-w-[1248px] mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center max-w-[1248px] mx-auto mt-10 text-center gap-6">
            {[
              ...
              <div key={idx} className="flex-1 group p-6 rounded-2xl hover:bg-white hover:shadow-lg transition-all duration-300">
